...
spm.SentencePieceTrainer.train(input=f'data/{src_lang}-{trg_lang}/trainconcat.{src_lang}.{trg_lang}', model_prefix=f'data/models/spm_model.bpe.{src_lang}.{trg_lang}', vocab_size=32000, model_type='bpe')
